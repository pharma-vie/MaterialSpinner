...
Base on [Material Design](https://github.com/ganfra/MaterialSpinner)


## Screenshots
![MaterialSpinner](https://raw.githubusercontent.com/captain-miao/me.github.com/master/spinner/spinner-with-the-material.gif)
...
```java
 ...
 MaterialSpinnerAdapter<String> adapter = new MaterialSpinnerAdapter<String>(this, android.R.layout.simple_spinner_item, ITEMS);
