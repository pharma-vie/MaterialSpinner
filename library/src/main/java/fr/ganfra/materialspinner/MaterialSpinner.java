...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    */
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        hintDropDownColor = array.getColor(R.styleable.MaterialSpinner_ms_hintDropDownColor, 0);
    ...
    private void initPadding() {
        ...
        extraPaddingTop = enableFloatingLabel ? floatingLabelTopSpacing + floatingLabelInsideSpacing + floatingLabelBottomSpacing * 2 : floatingLabelBottomSpacing;
        updateBottomPadding();
    ...
    private void updateBottomPadding() {
        ...
        if (enableErrorLabel) {
            extraPaddingBottom += (int) ((textMetrics.descent - textMetrics.ascent) * currentNbErrorLines) + extraPaddingBottom + underlineTopSpacing;
        }
        updatePadding();
    }
    ...
    */
    ...
    public int getHintDropDownColor() {
        return hintDropDownColor;
    }

    public void setHintDropDownColor(int hintDropDownColor) {
        this.hintDropDownColor = hintDropDownColor;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            width = Math.min(width + (int) (arrowSize + 0.5f), widthSize);
        } else {
            //Be whatever you want
            width += (int) (arrowSize + 0.5f);
        }
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        hintAdapter = new HintAdapter((MaterialSpinnerAdapter)adapter, getContext());
    ...
    private class HintAdapter extends BaseAdapter {
        ...
        public HintAdapter(MaterialSpinnerAdapter spinnerAdapter, Context context) {
        ...
        private View buildView(int position, View convertView, ViewGroup parent, boolean isDropDownView) {
            ...
            if (isDropDownView) {
                //textView.setTextColor(hintDropDownColor);
            } else {
        ...
        private View getHintView(final View convertView, final ViewGroup parent, final boolean isDropDownView) {
            ...
            final int resid = isDropDownView ?
                    mSpinnerAdapter.getDropDownResource() : mSpinnerAdapter.getResource();
            final TextView textView = (TextView) inflater.inflate(resid, parent, false);
            textView.setText(hint);
            if (isDropDownView) {
                if(hintDropDownColor != 0) {
                    textView.setTextColor(hintDropDownColor);
                }
            } else {
                textView.setTextColor(MaterialSpinner.this.isEnabled() ? hintColor : disabledColor);
